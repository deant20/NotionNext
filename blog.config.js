...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WeiY', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢骑行的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.weiy.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'WeiY,Notion,Blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'notion@weiy.xyz', // 邮箱地址 例如mail@tangly1024.com
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'feedId:69539858195179520+userId:68549797270874112', // 站点描述，被notion中的页面描述覆盖，这是一个由NotionNext生成的站点feedId:69539858195179520+userId:68549797270874112
